/****************************************************************************
** Meta object code from reading C++ file 'EG_Datamanager.h'
**
...
#include "../../../../EEG/EEGui/EG_Datamanager.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'EG_Datamanager.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DataManager_t, stringdata) + ofs \
...
const QMetaObject DataManager::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_DataManager.data,
