#include "EG_Mainwindow.h"
#include "ui_EG_Mainwindow.h"
  ...
  ui(new Ui::MainWindow)
{
  ...
  ui->customPlot->plotLayout()->addElement(0, 0, new QCPPlotTitle(ui->customPlot, "^0^ Examplejg ^0^"));
...
//    QFile file("F://EGGDATA//10-04-sleep-chengjian_New Reference.dat");
//    file.open(QIODevice::ReadOnly);
//    long totalByte=file.size();   //总共的字节数
//    long nFrames=totalByte/4/14;     //每个通道含有的浮点数
...
//    float (*data)[14] = new float[nFrames][14];
